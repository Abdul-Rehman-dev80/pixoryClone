...
export default function Section4() {
  ...
  const sliderData = cards.map((card, index) => ({
    content: (
  ...
  return (
    <div className="bg-gray-100 md:py-[50px]">
      <div className="max-w-7xl mx-auto px-6 flex flex-col justify-center items-center text-center md:pb-[100px]">
        ...
        <div className="md:hidden block text-center py-[50px]">
